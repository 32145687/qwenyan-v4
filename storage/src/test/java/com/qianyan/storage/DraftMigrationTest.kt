...
class DraftMigrationTest {
    ...
    fun `v2 to v3 migration preserves old data and enables draft crud`() {
        ...
        try {
            ...
            assertEquals(12L, userVersion(driver), "migration 后 user_version 应为 10（P14-F.2 Schema v10）")
    ...
    fun `fresh v3 database includes chapter draft table`() {
        ...
        assertEquals(12L, userVersion(driver), "全新库 user_version 应为 10（P14-F.2 Schema v10）")
